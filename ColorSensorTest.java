...
public class Final_Auto_V1 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    floor_color = hardwareMap.get(ColorSensor.class, "floor_color");
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        telemetry.addData("Red", floor_color.red());
        telemetry.addData("Green", floor_color.green());
        telemetry.addData("Blue", floor_color.blue());
